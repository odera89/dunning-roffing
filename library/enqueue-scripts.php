...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	...
	wp_enqueue_script( 'googlemaps', '//maps.googleapis.com/maps/api/js?key=AIzaSyDUg0PbTmF1GGA80nkyQXI747sxikuHL8Y&libraries=places&ver=3&callback', array('jquery'), '2.6.1', true );
