	...
	function foundationpress_breadcrumb( $showhome = true, $separatorclass = false ) {
		...
		if ( ! is_front_page() ) {
			...
			if(is_home()) {
				...
				echo '<li class="item-current item-' . $page_for_posts . '"><strong class="bread-current bread-' . $page_for_posts . '" title="' . get_the_title($page_for_posts) . '">' . get_the_title($page_for_posts) . '</strong></li>';
			}

			if ( is_single() && ! is_attachment() ) {

				if(is_singular('service')) {
					echo '<li class="item-cat"><a class="bread-cat" href="/services" title="services">Services</a></li>';
					if ( $separatorclass ) {
